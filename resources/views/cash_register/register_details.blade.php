      ...
      <div class="row">
        <div class="col-sm-12">
          <table class="table">
            ...
            <tr>
              <td>
                @lang('Pagamento CARTÃO DE CREDITO'):
              </td>
             <td>
            ...
            <!--<tr>-->
            <!--  <td>-->
            <!--    @lang('Pagamento cartão de Debito'):-->
            <!--  </td>-->
            <!--  <td>-->
            <!--    <span class="display_currency" data-currency_symbol="true">{{ $register_details->total_debit_card }}</span>-->
            <!--  </td>-->
            <!--</tr>-->
            <tr>
              <td>
