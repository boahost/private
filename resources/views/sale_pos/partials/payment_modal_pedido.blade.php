    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="pos-save-pedido-print">@lang('sale.finalize_payment')
                    imprimir</button>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                {!! Form::select('', ['credit' => 'Crédito', 'debit' => 'Débito'], 'visa', [
...
<div class="modal fade" tabindex="-1" role="dialog" id="modal_edit_line_boleto">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" id="close-modal-line-boleto"><span
                        aria-hidden="true">&times;</span></button>
