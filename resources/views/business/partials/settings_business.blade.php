    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                {!! Form::text('razao_social', $business->razao_social, [
                    'class' => 'form-control',
                    'required',
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::text('start_date', @format_date($business->start_date), [
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::text('default_profit_percent', @num_format($business->default_profit_percent), [
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                {!! Form::select(
                    ...
                    ['before' => __('lang_v1.before_amount'), 'after' => __('lang_v1.after_amount')],
                    $business->currency_symbol_placement,
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::select('time_zone', $timezone_list, $business->time_zone, [
                        'class' => 'form-control select2',
                        'required',
                    ]) !!}
                </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                {!! Form::file('business_logo', ['accept' => 'image/jpeg, image/png']) !!}
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::number('transaction_edit_days', $business->transaction_edit_days, [
                        'class' => 'form-control',
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::select('date_format', $date_formats, $business->date_format, [
                        'class' => 'form-control select2',
                        'required',
                    ]) !!}
                </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::select(
                        'time_format',
                        [12 => __('lang_v1.12_hour'), 24 => __('lang_v1.24_hour')],
        ...
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('ie', 'IE' . ':*') !!}
                {!! Form::text('ie', $business->ie, ['class' => 'form-control', 'required', 'placeholder' => 'IE']) !!}
            </div>
        </div>
        ...
        @if ($infoCertificado == -1)
            <h5 style="color: red">Erro na leitura do certificado, verifique a senha e outros dados, e realize o upload
                novamente!!</h5>
        @endif
        ...
        <div class="col-sm-2">
            <div class="form-group">
                ...
                {!! Form::text('senha_certificado', '', ['class' => 'form-control', 'placeholder' => 'Senha']) !!}
            </div>
        </div>
        ...
        <div class="col-sm-6">
            <div class="form-group">
                {!! Form::label('rua', 'Rua' . ':*') !!}
                {!! Form::text('rua', $business->rua, ['class' => 'form-control', 'required', 'placeholder' => 'Rua']) !!}
            </div>
        </div>
        ...
        <div class="col-sm-2">
            <div class="form-group">
                ...
                {!! Form::text('numero', $business->numero, ['class' => 'form-control', 'required', 'placeholder' => 'Número']) !!}
            </div>
        </div>
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                {!! Form::text('bairro', $business->bairro, ['class' => 'form-control', 'required', 'placeholder' => 'Bairro']) !!}
            </div>
        </div>
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                {!! Form::text('telefone', $business->telefone, [
                    'class' => 'form-control',
                    'required',
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                {!! Form::select('regime', ['1' => 'Simples', '3' => 'Normal'], $business->regime, [
                    'class' => 'form-control select2',
                    'required',
                ]) !!}
            </div>
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                {!! Form::text('ultimo_numero_nfe', $business->ultimo_numero_nfe, [
                    'class' => 'form-control',
                    'required',
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                {!! Form::text('ultimo_numero_nfce', $business->ultimo_numero_nfce, [
                    'class' => 'form-control',
                    'required',
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                {!! Form::text('inscricao_municipal', $business->inscricao_municipal, [
                    'class' => 'form-control',
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                {!! Form::text('numero_serie_nfe', $business->numero_serie_nfe, [
                    'class' => 'form-control',
                    'required',
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                {!! Form::text('numero_serie_nfce', $business->numero_serie_nfce, [
                    'class' => 'form-control',
                    'required',
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                {!! Form::select('ambiente', ['1' => 'Produção', '2' => 'Homologação'], $business->ambiente, [
                    'class' => 'form-control select2',
                    'required',
                ]) !!}
            </div>
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                {!! Form::text('csc_id', $business->csc_id, ['class' => 'form-control', 'required', 'placeholder' => 'CSCID']) !!}
            </div>
        </div>
        ...
        <div class="col-sm-5">
            <div class="form-group">
                {!! Form::label('csc', 'CSC' . ':*') !!}
                {!! Form::text('csc', $business->csc, ['class' => 'form-control', 'required', 'placeholder' => 'CSC']) !!}
            </div>
        </div>
        <div class="col-sm-3">
            <div class="form-group">
                {!! Form::label('aut_xml', 'AUT XML' . ':') !!}
                {!! Form::text('aut_xml', $business->aut_xml, ['class' => 'form-control cnpj', 'placeholder' => 'AUT XML']) !!}
            </div>
        </div>
