...
<div class="row">
        ...
        <div class="col-md-4">
            <div class="form-group">
                {!! Form::select('commission_agent', $commission_agent, null, [
                    'class' => 'form-control',
                    'required' => !empty($pos_settings['required_commission_agent']),
    ...
    @if (in_array('types_of_service', $enabled_modules) && !empty($types_of_service))
        <div class="col-md-4 col-sm-6">
            <div class="form-group">
                <div class="input-group">
                    <span class="input-group-addon">
                        <i class="fa fa-external-link-square-alt text-primary service_modal_btn">
                ...
                <small>
                    <p class="help-block hide" id="price_group_text">@lang('lang_v1.price_group'): <span>
                        </span>
                    </p>
                </small>
            </div>
    ...
    @if (in_array('subscription', $enabled_modules))
        <div class="col-md-4 col-sm-6">
            <div class="no-wrap flex flex-col gap-1 items-center">
                <label class="m-0">
                ...
                <button type="button" data-toggle="modal" data-target="#recurringInvoiceModal"
                    ...
                    Intervalos <i class="fa fa-external-link-alt ml-2"></i>
                </button>
            </div>
        </div>
    @endif
...
<div class="row">
    <div class="col-sm-12 pos_product_div">
        ...
        <table class="table table-condensed table-bordered table-striped table-responsive" id="pos_table">
            <thead>
                <tr>
                    <th class="tex-center @if (!empty($pos_settings['inline_service_staff'])) col-md-4 @else col-md-5 @endif">
