<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(document).on('change',
            '#formas_pagamento, #sell_list_filter_location_id, #sell_list_filter_customer_id, #sell_list_filter_payment_status, #created_by, #sales_cmsn_agnt, #service_staffs',
            function() {
                sell_table.ajax.reload();
            });
        ...
        sell_table = $('#sell_table').DataTable({
            ...
            "ajax": {
                ...
                "data": function(d) {
                    ...
                    if ($('#sell_list_filter_payment_status').length) {
                        ...
                        //d.payment_status = $('#sell_list_filter_payment_status').html();
                    }
            ...
            "fnDrawCallback": function(oSettings) {
                ...
                $('#footer_payment_status_count ').html(__sum_status_html($('#sell_table'),
                    'payment-status-label'));
                $('#service_type_count').html(__sum_status_html($('#sell_table'),
                    'service-type-label'));
                $('#payment_method_count').html(__sum_status_html($('#sell_table'),
                    'payment-method'));
