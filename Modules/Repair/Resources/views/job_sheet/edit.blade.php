...
@section('content')
    ...
    <section class="content">
        ...
        @endif
        {!! Form::open([
            'url' => action('\Modules\Repair\Http\Controllers\JobSheetController@update', ['job_sheet' => $job_sheet->id]),
            'method' => 'put',
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::textarea('product_configuration', $job_sheet->product_configuration, [
                                'class' => 'tags-look form-control width-100',
                                'rows' => 3,
                            ]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::textarea('defects', $job_sheet->defects, [
                                'class' => 'tags-look form-control width-100',
                                'rows' => 3,
                            ]) !!}
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::textarea('product_condition', $job_sheet->product_condition, [
                                'class' => 'tags-look form-control width-100',
                                'rows' => 3,
                            ]) !!}
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            {!! Form::textarea('comment_by_ss', $job_sheet->comment_by_ss, [
                                'class' => 'form-control',
                                'rows' => '3',
                            ]) !!}
                        </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            {!! Form::label('service_costs', __('repair::lang.service_costs') . ':') !!}
                            {!! Form::text(
                                'service_costs',
                                !empty($job_sheet->service_costs) ? @num_format($job_sheet->service_costs) : null,
                                [
                                    'class' => 'form-control input_number',
                                    'placeholder' => '0,00',
                                ],
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            {{-- colocar serviços realizados --}}
                            {!! Form::label('services_performed', __('repair::lang.services_performed') . ':') !!}
                            {!! Form::textarea('services_performed', null, [
                                'class' => 'form-control',
                                'rows' => '3',
                            ]) !!}
                        </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('custom_field_1', $job_sheet->custom_field_1, [
                                'class' => 'form-control',
                            ]) !!}
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('custom_field_2', $job_sheet->custom_field_2, [
                                'class' => 'form-control',
                            ]) !!}
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('custom_field_3', $job_sheet->custom_field_3, [
                                'class' => 'form-control',
                            ]) !!}
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('custom_field_4', $job_sheet->custom_field_4, [
                                'class' => 'form-control',
                            ]) !!}
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('custom_field_5', $job_sheet->custom_field_5, [
                                'class' => 'form-control',
                            ]) !!}
                        </div>
                    </div>
