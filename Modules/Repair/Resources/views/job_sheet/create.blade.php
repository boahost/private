        ...
        <div class="box box-solid">
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        {!! Form::label('service_type', __('repair::lang.service_type') . ':*') !!}
                        <br>
                        <label class="radio radio-inline pa-0">
                        ...
                        <label class="radio radio-inline pa-0 radio_btns">
                            {!! Form::radio('service_type', 'on_site', false, ['class' => 'input-icheck']) !!}
                            @lang('repair::lang.on_site')
                        </label>
                    </div>
                    <div class="col-md-12 pick_up_onsite_addr" style="display: none;">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::textarea('product_configuration', null, [
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::textarea('product_condition', null, [
                                'class' => 'tags-look form-control width-100',
                                'rows' => 3,
                            ]) !!}
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            {!! Form::textarea('comment_by_ss', null, [
                                'class' => 'form-control',
                                'rows' => '3',
                            ]) !!}
                        </div>
