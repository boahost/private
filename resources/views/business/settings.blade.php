                ...
                <div class="col-xs-12 pos-tab-container">
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 pos-tab-menu">
                        <div class="list-group">
                            ...
                            <a href="#" class="list-group-item text-center">Taxas
                            ...
                            <a href="#" class="list-group-item text-center">@lang('integration.integration')</a>
                            <a href="#" class="list-group-item text-center">@lang('PDV')</a>
                            ...
                            <a href="#" class="list-group-item text-center">@lang('ADM PRIVATE SISTEMAS')</a>
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 pos-tab">
                        ...
                        @include('business.partials.settings_integration')
