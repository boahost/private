                ...
                @component('components.filters', ['title' => __('report.filters')])
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            {!! Form::select('expense_payment_status', ['1' => 'Recebido', '-1' => 'Pendente'], null, [
                                'class' => 'form-control select2',
                                'style' => 'width:100%',
                ...
                @component('components.widget', ['class' => 'box-primary', 'title' => ''])
                    @can('expense.access')
                        @slot('tool')
                            ...
                            <div class="box-tools" style="margin-right: 3px;">
                                <button style="display: none;" type="button" class="btn btn-block btn-success btn-gerar-boletos"
                        ...
                        <table class="table table-bordered table-striped" id="revenue_table">
                            ...
                            <tfoot>
                                <tr class="bg-gray font-17 text-center footer-total">
                                    ...
                                    <td><span class="display_currency" id="footer_total_receive"
                                            data-currency_symbol ="true"></span></td>
                                    <td colspan="2"></td>
                                </tr>
                            </tfoot>
