            ...
            <div class="row">
                <div class="col-sm-12">
                    <table class="table">
                        <tr>
                            <td>
                                @lang('Dinheiro abertura de CAIXA'):
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                @lang('Pagamento Cartão de CRÉDITO'):
                            </td>
                            <td>
                                <span class="display_currency"
                        ...
                        @endif
                        @if (array_key_exists('pix_efi', $payment_types))
                            <tr>
                                <td>
                                    {{ $payment_types['pix_efi'] }}:
                                </td>
                                <td>
                                    <span class="display_currency"
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="display_currency"
                                    data-currency_symbol="true">{{ $register_details->total_sale }}
                                </span>
                            </td>
                        </tr>
