<div class="row">
    <div class="col-md-12">
        <table class="table table-condensed">
            ...
            <tr>
                <td>
                    <div aria-hidden="true" data-toggle="modal" data-target="#posEditDiscountModal">
                        <div class="btn btn-round btn-border-danger btn-flat">
                            ...
                            <i class="fas fa-pen" id="pos-edit-discount" title="@lang('sale.edit_discount')"></i>
                ...
                <td class="@if ($pos_settings['disable_order_tax'] != 0) hide @endif">
                    <span>
                        <div class="btn btn-round btn-border-danger btn-flat" aria-hidden="true" data-toggle="modal"
                            ...
                            <i class="fas fa-pen cursor-pointer" title="@lang('sale.edit_order_tax')"></i>
                ...
                <td class="@if ($pos_settings['disable_discount'] != 0) hide @endif">
                    <span>
                        <div class="btn btn-round btn-border-danger btn-flat" aria-hidden="true" data-toggle="modal"
                            ...
                            <i class="fas fa-pen cursor-pointer" title="@lang('sale.shipping')"></i>
