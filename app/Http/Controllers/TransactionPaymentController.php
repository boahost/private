...
class TransactionPaymentController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            if ($transaction->payment_status != 'paid') {
                ...
                // if ($request->input('method') !== 'pix_efi')
    ...
    public function show($id)
    {
        ...
        if (request()->ajax()) {
            ...
            $payment_types = $this->transactionUtil->payment_types(null, $transaction->business_id);
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $inputs['vencimento'] = $request->input('vencimento'); //$inputs['paid_on'];
    ...
    public function addPayment($transaction_id)
    {
        ...
        if (request()->ajax()) {
            ...
            if ($transaction->payment_status != 'paid') {
                ...
                $payment_line->vencimento = \Carbon::now()->toDateTimeString();
