<tr class="product_row" data-row_index="{{ $row_count }}">
    ...
    <td class="{{ $hide_tax }}">
        <input type="text" name="products[{{ $row_count }}][unit_price_inc_tax]"
            class="form-control pos_unit_price_inc_tax input_number text-right"
    ...
    <td class="text-center">
        ...
        <input type="{{ $subtotal_type }}"
            class="form-control pos_line_total @if (!empty($pos_settings['is_pos_subtotal_editable'])) input_number text-right @endif"
    ...
    <td class="text-center justfy-center flex items-center">
        <button type="button" trigger="pos_remove_row" class="btn btn-danger btn-flat">
