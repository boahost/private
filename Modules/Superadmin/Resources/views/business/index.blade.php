                            ...
                            <div class="box box-widget widget-user-2">
                                ...
                                <div class="widget-user-header bg-yellow">
                                    <div class="widget-user-image">
                                        @if (!empty($business->logo))
                                            <img class="img-circle" src="{{ url('uploads/business_logos/' . $business->logo) }}"
                                                alt="Business Logo">
                                        @endif
                                    </div>
                                    <!-- /.widget-user-image -->
                                ...
                                <div class="box-footer">
                                    ...
                                    <button type="button" class="btn btn-secondary btn-xs btn-modal"
                                        data-href="{{ action('\Modules\Superadmin\Http\Controllers\SuperadminTaxesController@index', ['business_id' => $business->id]) }}"
                                        data-container=".view_modal">
                                        Taxas
                                    </button>

                                    <button type="button" class="btn btn-primary btn-xs btn-modal"
                                        data-href="{{ action('\Modules\Superadmin\Http\Controllers\SuperadminSubscriptionsController@create', ['business_id' => $business->id]) }}"
                                        data-container=".view_modal">
