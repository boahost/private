...
<input type="hidden" id="repair_job_sheet_id" name="repair_job_sheet_id"
    value="@if (!empty($repair['repair_job_sheet_id'])) {{ $repair['repair_job_sheet_id'] }} @endif">
    ...
    <div class="col-sm-4">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                {!! Form::text(
                    'repair_due_date',
                    !empty($repair['repair_due_date']) ? @format_datetime($repair['repair_due_date']) : null,
                    ['class' => 'form-control', 'readonly'],
                ) !!}
                <span class="input-group-addon">
                    <i class="cursor-pointer fas fa-times-circle clear_repair_due_date"></i>
                </span>
            </div>
        </div>
    </div>
    <div class="col-sm-4">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                {!! Form::text(
                    'repair_completed_on',
                    !empty($repair['repair_completed_on']) ? @format_datetime($repair['repair_completed_on']) : null,
                    ['class' => 'form-control', 'readonly'],
                ) !!}
                <span class="input-group-addon">
                    <i class="cursor-pointer fas fa-times-circle clear_repair_completed_on"></i>
                </span>
            </div>
        </div>
    </div>
    @if (!empty($view_data['warranties']))
        <div class="col-sm-4">
            <div class="form-group">
                ...
                {!! Form::select(
                    'repair_warranty_id',
                    $view_data['warranties'],
                    !empty($repair['repair_warranty_id']) ? $repair['repair_warranty_id'] : null,
...
<div class="row">
    <div class="col-sm-4">
        <div class="form-group">
            ...
            {!! Form::select(
                'repair_brand_id',
                $view_data['brands'],
                !empty($repair['repair_brand_id']) ? $repair['repair_brand_id'] : null,
                ['class' => 'form-control select2', 'placeholder' => __('messages.please_select')],
            ) !!}
        </div>
    </div>
    <div class="col-sm-4">
        <div class="form-group">
            ...
            {!! Form::select(
                'repair_device_id',
                $view_data['devices'],
                !empty($repair['repair_device_id']) ? $repair['repair_device_id'] : null,
                ['class' => 'form-control select2', 'placeholder' => __('messages.please_select')],
            ) !!}
        </div>
    </div>
    <div class="col-sm-4">
        <div class="form-group">
            ...
            {!! Form::select(
                'repair_model_id',
                $view_data['device_models'],
                !empty($repair['repair_model_id']) ? $repair['repair_model_id'] : null,
                ['class' => 'form-control select2', 'placeholder' => __('messages.please_select')],
            ) !!}
        </div>
    </div>
...
<div class="row">
    <div class="col-sm-4">
        <div class="form-group">
            ...
            {!! Form::text('repair_serial_no', !empty($repair['repair_serial_no']) ? $repair['repair_serial_no'] : null, [
                'class' => 'form-control',
    ...
    <div class="col-sm-6 mt-15">
        <div class="mt-5 btn-group" role="group">
            <button type="button" class="btn btn-primary btn-flat" data-toggle="modal"
                data-target="#checklist_modal"><i class="fa fa-plus"></i> @lang('repair::lang.pre_repair_checklist')</button>
            <button type="button" class="btn btn-primary btn-flat" data-toggle="modal" data-target="#security_modal"><i
                    class="fa fa-lock"></i> @lang('repair::lang.security')</button>
        </div>
    </div>
</div>
<div class="row">
