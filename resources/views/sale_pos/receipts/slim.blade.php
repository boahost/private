        ...
        <div class="ticket">
			...
			@if(!empty($receipt_details->shipping_address))
				...
				<table class="border-top width-100">
					<tr>
						<th class="width-50 " colspan="2">
							<p class="centered">Entrega</p>
						</th>
					</tr>
					<tr>
						<td width="15%" class="left">Endereço</td>
						<td class="right">{{$receipt_details->shipping_address}}</td>
					</tr>
					<tr>
						<td width="15%" class="left">Para</td>
						<td class="right">{{$receipt_details->delivered_to}}</td>
					</tr>
					<tr>
						<td class="left">Observação</td>
						<td class="right">{{$receipt_details->shipping_details}}</td>
					</tr>
				</table>
			@endif
