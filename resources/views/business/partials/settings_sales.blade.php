        ...
        <div class="col-sm-12">
            <div class="form-group">
                <div class="checkbox">
                    ...
                    <label class="pa-0">
                        {!! Form::checkbox(
                            'pos_settings[required_commission_agent]',
                            1,
                            !empty($pos_settings['required_commission_agent']) ? true : false,
                            ['class' => 'input-icheck'],
                        ) !!} {{ __('lang_v1.required_commission_agent') }}
                    </label>
                    @show_tooltip(__('lang_v1.required_commission_agent_help'))
                </div>
            </div>
        </div>
