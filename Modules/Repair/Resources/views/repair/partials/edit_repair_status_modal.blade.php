<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        {!! Form::open([
            'url' => action('\Modules\Repair\Http\Controllers\RepairController@updateRepairStatus'),
            'method' => 'post',
            'id' => 'update_repair_status_form',
        ]) !!}
            ...
            <div class="row mt-15">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        {!! Form::select(
                            'repair_status_id_modal',
                            $repair_status_dropdown['statuses'],
                            ...
                            $repair_status_dropdown['template'],
                        ) !!}
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        {!! Form::textarea('update_note', null, [
                            'class' => 'form-control',
                            'placeholder' => __('repair::lang.update_note'),
                            'rows' => 3,
                            'id' => 'update_note',
                        ]) !!}
                    </div>
