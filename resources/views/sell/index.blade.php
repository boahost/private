        ...
        $(document).ready(function() {
            ...
            sell_table = $('#sell_table').DataTable({
                ...
                "footerCallback": function(row, data, start, end, display) {
                    ...
                    for (var r in data) {
                        footer_sale_total += typeof($(data[r].final_total).data('orig-value')) !=
                            'undefined' ? parseFloat($(data[r].final_total).data('orig-value')) : 0;
                        footer_total_paid += typeof($(data[r].total_paid).data('orig-value')) !=
                            'undefined' ? parseFloat($(data[r].total_paid).data('orig-value')) : 0;
                        footer_total_remaining += typeof($(data[r].total_remaining).data(
                            'orig-value')) != 'undefined' ? parseFloat($(data[r].total_remaining)
                            .data(
                                'orig-value')) : 0;
                        footer_total_sell_return_due += typeof($(data[r].return_due).data(
                            'orig-value')) != 'undefined' ? parseFloat($(data[r].return_due).data(
                            'orig-value')) : 0;
                    }
