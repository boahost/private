...
<div class="modal fade" tabindex="-1" role="dialog" id="posEditDiscountModal">
    <div class="modal-dialog modal-sm" role="document">
        <form action="javascript:" id="posEditDiscountModalUpdate">
                        ...
                        <div class="col-xs-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    {{-- <div class="col-md-5"> --}}
                                    <label class="radio-inline pa-0">
                                        {!! Form::radio('discount_type_modal', 'fixed', true, ['class' => 'input-icheck', 'required']) !!}
                                        @lang('lang_v1.fixed')
                                    </label>
                                    <label class="radio-inline">
                                        {!! Form::radio('discount_type_modal', 'percentage', false, ['class' => 'input-icheck']) !!}
                        ...
                        <div class="well well-sm bg-light-gray col-md-12">
                            ...
                            <div class="col-md-6">
                                <p><strong>@lang('lang_v1.available'):</strong> <span
                                        id="available_rp">{{ $max_available }}</span>
                                </p>
