        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <form action="#" class="mt-5">
                    <input class="form-control" id="buscar" type="text" placeholder="Digite aqui para buscar">
                </form>
            </div>
    ...
    <script>
        $(document).ready(function() {
            $("#buscar").on("input", function() {
                ...
                $(".small-box.bg-yellow").each(function() {
                    var sale = $(this);
                    var saleText = sale.text().toLowerCase();

                    if (saleText.includes(termoBusca)) {
                        sale.show();
                    } else {
                        sale.hide();
                    }
...
<div class="modal-dialog modal-lg" role="document">
	<div class="modal-content">
		<div class="modal-header">
            ...
            <input id="buscar" type="text" placeholder="Digite aqui para buscar">
