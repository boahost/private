<section class="no-print">
    <nav class="m-4 bg-white navbar navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand"
                    href="{{ action('\Modules\Repair\Http\Controllers\DashboardController@index') }}"><i
                        class="fas fa-wrench"></i> {{ __('repair::lang.repair') }}
                </a>
            </div>
    ...
    auth()->user()->can('repair.view_own'))
                    ...
                    @can('repair.create')
                        <li @if (request()->segment(2) == 'repair' && request()->segment(3) == 'create') class="active" @endif><a
    ...
    auth()->user()->can('brand.create'))
                    ...
                    @if (auth()->user()->can('edit_repair_settings'))
                        <li @if (request()->segment(1) == 'repair' && request()->segment(2) == 'repair-settings') class="active" @endif><a
