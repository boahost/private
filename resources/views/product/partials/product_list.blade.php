        ...
        <td colspan="{{ $colspan }}">
            <div style="display: flex; width: 100%;">
                ...
                @can('product.update')
                    ...
                    {!! Form::close() !!}
                    &nbsp;
                    <button type="button" class="btn btn-xs btn-success update_product_location" data-type="add">Adicionar
                        localização</button>
                    &nbsp;
                    <button type="button" class="btn btn-xs bg-navy update_product_location" data-type="remove">Remover
                        localização</button>
                @endcan
                &nbsp;
                {!! Form::open([
                ...
                {!! Form::submit('Desativar selecionado', ['class' => 'btn btn-xs btn-warning', 'id' => 'deactivate-selected']) !!}
